...
//    public static final String BASE_URL = "http://192.168.1.169:3000/";  //Localhost
    ...
    public static final String CHECKOUT="create_checkout";

    public static final String ISONLINESTATUS="target_session_status";
    public static final String LOGGED_HOURS="logged_hours";
}
